...
print(f"==================== GENERATING 7m IB / 1m STEP TESTS ====================")
...
dash_content = dash_content.replace('IB Research Terminal — NQ & ES', 'IB Research Terminal (7m IB, 1m step) — NQ & ES')
...
print(f"7m IB / 1m step tests and dashboard generation completed successfully!\n")
