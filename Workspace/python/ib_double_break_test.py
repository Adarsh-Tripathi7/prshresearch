...
def main():
    ...
    plots_path = os.path.join(results_dir, "ib_double_break_directional_heatmap.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_double_break_directional_dashboard.md")
