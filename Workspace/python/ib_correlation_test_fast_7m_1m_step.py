...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_7m_1m_step.csv")
    ...
    plt.ylabel('Rolling 7-Minute Window')
    plt.xlabel('Leader & Break Direction')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_7m_1m_step.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_7m_1m_step.md")
