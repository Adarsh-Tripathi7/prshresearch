...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_first_break_10m.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_first_break_heatmap_10m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_first_break_dashboard_10m.md")
