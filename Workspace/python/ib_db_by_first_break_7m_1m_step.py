...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_first_break_7m_1m_step.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_first_break_heatmap_7m_1m_step.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_first_break_dashboard_7m_1m_step.md")
