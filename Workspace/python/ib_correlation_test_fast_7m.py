...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_7m.csv")
    ...
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_7m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_7m.md")
