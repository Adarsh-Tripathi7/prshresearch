...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_rth_close_15m_step.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_rth_heatmap_15m_step.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_rth_dashboard_15m_step.md")
