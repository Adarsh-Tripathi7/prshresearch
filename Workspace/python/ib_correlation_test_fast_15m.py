...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_15m.csv")
    ...
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_15m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_15m.md")
