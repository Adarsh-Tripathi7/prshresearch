...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_10m.csv")
    ...
    plt.ylabel('Rolling 10-Minute Window')
    plt.xlabel('Leader & Break Direction')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_10m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_10m.md")
