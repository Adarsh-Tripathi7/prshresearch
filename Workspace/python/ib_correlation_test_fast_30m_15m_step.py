...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_30m_15m_step.csv")
    ...
    plt.ylabel('Rolling 30-Minute Window')
    plt.xlabel('Leader & Break Direction')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_30m_15m_step.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_30m_15m_step.md")
