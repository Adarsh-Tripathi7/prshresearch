...
suffix = "_30m_15m_step"

print(f"==================== GENERATING 30m IB / 15m STEP TESTS ====================")
for script in scripts_to_convert:
    ...
    content = content.replace("60-minute windows", "30-minute windows")
    content = content.replace("60m rolling", "30m rolling")
...
dash_content = dash_content.replace('IB Research Terminal — NQ & ES', 'IB Research Terminal (30m IB, 15m step) — NQ & ES')
dash_content = dash_content.replace('60m rolling · 30m step', f'30m rolling · {step}m step')
...
print(f"30m IB / 15m step tests and dashboard generation completed successfully!\n")
