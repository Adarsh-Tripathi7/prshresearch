...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional.csv")
    ...
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard.md")
