...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_rth_close_30m_15m_step.csv")
    ...
    plt.ylabel('Rolling 30-Minute IB Window')
    plt.xlabel('Asset')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "db_probability_rth_heatmap_30m_15m_step.png")
...
*What is the raw statistical probability that a given 30-minute Initial Balance will eventually suffer a Double Break before the 16:00 EST market close?*
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_rth_dashboard_30m_15m_step.md")
