...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_30m.csv")
    ...
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_30m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_30m.md")
