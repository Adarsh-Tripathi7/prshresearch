...
def main():
    ...
    plots_path = os.path.join(results_dir, "ib_double_break_directional_heatmap_15m_step.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_double_break_directional_dashboard_15m_step.md")
