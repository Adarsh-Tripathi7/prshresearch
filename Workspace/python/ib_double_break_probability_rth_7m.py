...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_rth_close_7m.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_rth_heatmap_7m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_rth_dashboard_7m.md")
