...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_first_break_15m_step.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_first_break_heatmap_15m_step.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_first_break_dashboard_15m_step.md")
