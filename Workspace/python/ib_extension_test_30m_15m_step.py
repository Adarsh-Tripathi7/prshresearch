...
def main():
    ...
    while start_time <= 1260: # 14:00
        windows_list.append([start_time, start_time + 29])
        h1 = ((start_time // 60) + 17) % 24
        m1 = start_time % 60
        h2 = (((start_time + 29) // 60) + 17) % 24
        m2 = (start_time + 29) % 60
    ...
    def get_percentile_matrix(df_subset, filename_prefix):
        ...
        csv_path = os.path.join(results_dir, f"{filename_prefix}_percentiles_30m_15m_step.csv")
...
- `nq_double_break_high_first_percentiles_30m_15m_step.csv`
- `nq_double_break_low_first_percentiles_30m_15m_step.csv`
- `nq_single_break_high_first_percentiles_30m_15m_step.csv`
- `nq_single_break_low_first_percentiles_30m_15m_step.csv`
- `es_double_break_high_first_percentiles_30m_15m_step.csv`
- `es_double_break_low_first_percentiles_30m_15m_step.csv`
- `es_single_break_high_first_percentiles_30m_15m_step.csv`
- `es_single_break_low_first_percentiles_30m_15m_step.csv`
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_extension_detailed_dashboard_30m_15m_step.md")
