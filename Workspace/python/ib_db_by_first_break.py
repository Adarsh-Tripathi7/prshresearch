...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_first_break.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_first_break_heatmap.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_first_break_dashboard.md")
