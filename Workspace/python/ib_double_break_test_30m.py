...
def main():
    ...
    plt.title('Rolling 30m IB Double Break Correlation by Resolution Direction')
    plt.ylabel('Rolling 30-Minute Window')
    plt.xlabel('Leader & Resolution Direction')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "ib_double_break_directional_heatmap_30m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_double_break_directional_dashboard_30m.md")
