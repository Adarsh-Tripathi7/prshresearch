...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_120m.csv")
    ...
    plt.ylabel('Rolling 120-Minute Window')
    plt.xlabel('Leader & Break Direction')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_120m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_120m.md")
