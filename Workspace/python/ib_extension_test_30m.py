...
def main():
    ...
    def get_percentile_matrix(df_subset, filename_prefix):
        ...
        csv_path = os.path.join(results_dir, f"{filename_prefix}_percentiles_30m.csv")
...
- `nq_double_break_high_first_percentiles_30m.csv`
- `nq_double_break_low_first_percentiles_30m.csv`
- `nq_single_break_high_first_percentiles_30m.csv`
- `nq_single_break_low_first_percentiles_30m.csv`
- `es_double_break_high_first_percentiles_30m.csv`
- `es_double_break_low_first_percentiles_30m.csv`
- `es_single_break_high_first_percentiles_30m.csv`
- `es_single_break_low_first_percentiles_30m.csv`
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_extension_detailed_dashboard_30m.md")
