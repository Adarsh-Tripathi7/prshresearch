...
def main():
    ...
    # Save to CSV
    csv_path = os.path.join(results_dir, "db_probability_by_rth_close_120m.csv")
    ...
    plots_path = os.path.join(results_dir, "db_probability_rth_heatmap_120m.png")
...
*What is the raw statistical probability that a given 120-minute Initial Balance will eventually suffer a Double Break before the 16:00 EST market close?*
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "db_probability_rth_dashboard_120m.md")
