...
OUT_PATH = r"d:\Antigravity\Dashboard\ib_interactive_dashboard_15m.html"
...
# Load all datasets
prob = read_csv_json("db_probability_by_rth_close_15m.csv")
prob_first = read_csv_json("db_probability_by_first_break_15m.csv")
corr = read_csv_json("ib_correlation_directional_15m.csv")
...
for asset in ["nq", "es"]:
    ...
    for btype in ["double_break", "single_break", "all_breaks"]:
        ...
        for direction in ["combined", "high_first", "low_first"]:
            fname = f"{asset}_{btype}_{direction}_percentiles_15m.csv"
...
<title>IB Research Terminal (15m) — NQ & ES</title>
