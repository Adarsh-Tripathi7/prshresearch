...
def main():
    ...
    csv_path = os.path.join(results_dir, "ib_correlation_directional_45m.csv")
    ...
    plt.ylabel('Rolling 45-Minute Window')
    plt.xlabel('Leader & Break Direction')
    plt.tight_layout()
    
    plots_path = os.path.join(results_dir, "ib_correlation_directional_heatmap_45m.png")
...
"""
    ...
    dashboard_path = os.path.join(results_dir, "ib_correlation_directional_dashboard_45m.md")
